...
# ALLOWED_HOSTS = []
# Кроме того, в список ALLOWED_HOSTS в файле settings.py необходимо добавить IP-адрес и (если есть) доменное имя вашего сервера.
#
# ALLOWED_HOSTS = ['123.123.123.123', '<your_domain>']
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'nkpythonpract.zapto.org']
